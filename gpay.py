...
Abishek=gp.Google_pay("Abishek.Thakur@gmail.com","9003085347","AbishekThakur")
Abishek.open_gpay()
Abishek.email_verification()
Abishek.mobile_verification()
Abishek.name_verification()
Abishek.otp_verification(15698,15698)
Abishek.Bank_verification(3265789023)
Abishek.PanCard_Verification()
Abishek.set_Pin("5384")
Abishek.Enter_your_Pin(3465,3465)
...
Thakur=Phone_pe("abishekas94@gmail.com","9003085347","Abishek")
Thakur.open_phonepe()
Thakur.mobile_verification()
Thakur.name_verification()
Thakur.otp_verification(780965,780965)
Thakur.Bank_verification(3265789023)
Thakur.PanCard_Verification()
Thakur.set_Pin("238790")
